    ...
    <div className="space-y-6">
      ...
      <Card className="shadow-lg">
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Badge
              variant={
                result.result.includes("NOT FAKE") ? "default" : "destructive"
              }
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>Breakdown of verification metrics</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="w-20 bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${result.breakdown.entity_similarity * 100}%`,
                        }}
                      ></div>
                    </div>
                    <span
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    >
                      {Math.round(result.breakdown.semantic_similarity * 100)}%
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    >
                      {Math.round(result.breakdown.source_credibility * 100)}%
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    >
                      {Math.round(result.breakdown.per_entity.persons * 100)}%
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    >
                      {Math.round(result.breakdown.per_entity.locations * 100)}%
                    </span>
                  </div>
                </div>
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="w-20 bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${result.breakdown.per_entity.events * 100}%`,
                        }}
                      ></div>
                    </div>
                    <span
      ...
      {result.semantic_ranking && result.semantic_ranking.length > 0 && (
        <Card className="shadow-lg">
          ...
          <CardContent>
            <div className="space-y-3">
              {/* SHOW ONLY TOP 3 */}
              {result.semantic_ranking.slice(0, 3).map((news, index) => (
                <div
                  key={index}
